...
/opt/vault/bin/run-vault \
  ...
  --enable-auto-unseal --auto-unseal-kms-key-id "${vault_unseal_key_arn}" \
  --auto-unseal-kms-key-region "${aws_region}" \
  --auto-unseal-endpoint "https://kms${aws_endpoint_name_suffix}.${aws_region}.${aws_endpoint_url_suffix}"
